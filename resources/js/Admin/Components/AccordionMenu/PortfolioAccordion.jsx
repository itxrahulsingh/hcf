...
export default function PortfolioAccordion({ addMenu, selectedLang }) {
    const [isOpen, setIsOpen] = useState(false)
    const [isSelectAll, setIsSelectAll] = useState(false)
    const [selectedItems, setSelectedItems] = useState([])
    const { portfolio_menu: portfolios } = usePage().props
    const portfolio_menu = { data: portfolios?.data[selectedLang] }

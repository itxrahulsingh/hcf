...
export default function CTASectionCustomize({ index }) {
    ...
    if (data.layout === "1") {
        ...
        customizer = (
            <>
                <div className="form-group">
                    <label>Background image (1296x580 px)</label>
                    <SingleMediaUploader
                        onSelected={(e) => {
                            setData(
                                produce((draft) => {
        ...
        customizer = (
            <>
                <div className="form-group">
                    <label>Background image (460 px)</label>
                    <SingleMediaUploader
                        onSelected={(e) => {
                            setData(
                                produce((draft) => {
                                ...
                                {["1", "2", "3", "4"].map((value) => (
                                    <div key={value} className="cs_section_image" onClick={() => setLayout(!layout)}>
                                        ...
                                        <div className="cs_section_image_in">
                                            <img src={`/static/sections/cta/cta_style_${value}.jpg`} alt="Thumb" loading="lazy" decoding="async"/>

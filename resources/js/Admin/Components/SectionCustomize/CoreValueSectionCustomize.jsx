...
export default function CoreValueSectionCustomize({ index }) {
    ...
    if (data.layout === "1") {
        ...
        customizer = (
            <>
                <div className="form-group">
                    <label>Thumbnail (740x1100 px)</label>
                    <SingleMediaUploader
                        onSelected={(e) => {
                            setData(
                                produce((draft) => {
                                ...
                                {["1", "2", "3", "4", "5"].map((value) => (
                                    <div key={value} className="cs_section_image" onClick={() => setLayout(!layout)}>
                                        ...
                                        <div className="cs_section_image_in">
                                            <img src={`/static/sections/core_value/core_value_style_${value}.jpg`} alt="Thumb" loading="lazy" decoding="async"/>
                                            <label htmlFor={`layout-${value}`}>Core Value Style {value}</label>
                                        </div>
                                    </div>
                                ))}
                            </div>

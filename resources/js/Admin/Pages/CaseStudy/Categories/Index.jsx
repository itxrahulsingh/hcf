                                ...
                                <div className="yooDataTableWrap">
                                    <div className="dataTables_heading">
                                        ...
                                        <div className="dataTables_heading_right">
                                            ...
                                            {hasPermission("case_study_categories.create") && (
                                                <Link
                                                    href={route("admin.case.study.categories.create")}
                                                ...
                                                {categories.data.map((category, index) => (
                                                    <tr className="odd" key={index}>
                                                        ...
                                                        <td>
                                                            ...
                                                            >
                                                                {hasPermission("case_study_categories.edit") && (
                                                                    <Link
                                                                        href={route("admin.case.study.categories.edit", category)}
                                                                ...
                                                                {hasPermission("case_study_categories.delete") && (
                                                                    <DeleteButton href={route("admin.case.study.categories.destroy", category)} />
                                                                )}
                                                            </div>
                                                        </td>
                                                    </tr>

...
export default function Edit({ default_lang, languages, edited_gateway }) {
    ...
    const handlePublish = (e) => {
        e.preventDefault()
        post(route("admin.manual.payment.gateway.update", edited_gateway))
    }
    ...
    return (
        <AdminLayouts>
            <Head title="Edit Manual Payment Gateway" />
            <div className="yoo-height-b30 yoo-height-lg-b30" />
            <div className="container">
                <div className="yoo-uikits-heading">
                    <h2 className="yoo-uikits-title">{translate("Edit Manual Payment Gateway")}</h2>
                </div>

...
import { idCardOutline, search } from "ionicons/icons"
                                ...
                                <div className="yooDataTableWrap">
                                    <div className="dataTables_heading">
                                        ...
                                        <div className="dataTables_heading_right">
                                            ...
                                            {hasPermission("portfolio_categories.create") && (
                                                <Link
                                                    href={route("admin.portfolios.categories.create")}
                                                ...
                                                {categories.data.map((category, index) => (
                                                    <tr className="odd" key={index}>
                                                        ...
                                                        <td>
                                                            ...
                                                            >
                                                                {hasPermission("portfolio_categories.edit") && (
                                                                    <Link
                                                                        href={route("admin.portfolios.categories.edit", category)}
                                                                ...
                                                                {hasPermission("portfolio_categories.delete") && (
                                                                    <DeleteButton href={route("admin.portfolios.categories.destroy", category)} />
                                                                )}
                                                            </div>
                                                        </td>
                                                    </tr>

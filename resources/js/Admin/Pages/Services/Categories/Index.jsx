...
export default function Index({ categories, sort, filtered_lang, languages }) {
    ...
    const [selectedOption, setSelectedOption] = useState(translate(translate("Bulk Action")))
                                ...
                                <div className="yooDataTableWrap">
                                    <div className="dataTables_heading">
                                        ...
                                        <div className="dataTables_heading_right">
                                            ...
                                            {hasPermission("service_categories.create") && (
                                                <Link
                                                    href={route("admin.services.categories.create")}
                                                ...
                                                {categories.data.map((category, index) => (
                                                    <tr className="odd" key={index}>
                                                        ...
                                                        <td>
                                                            ...
                                                            >
                                                                {hasPermission("service_categories.edit") && (
                                                                    <Link
                                                                        href={route("admin.services.categories.edit", category)}
                                                                ...
                                                                {hasPermission("service_categories.delete") && (
                                                                    <DeleteButton href={route("admin.services.categories.destroy", category)} />
                                                                )}
                                                            </div>
                                                        </td>
                                                    </tr>

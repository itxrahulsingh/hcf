...
export default function ContactWithFormBuilder3({ sections_data }) {
    ...
    const handleSetData = (e, label, placeholder, fieldType = "text") => {
        ...
        // --- Handle Checkbox ---
            ...
            if (isChecked) {
                ...
                setData(fieldName, currentValues.filter((val) => val !== checkboxValue))
            }
        }
        // --- Standard Inputs ---
        else {
    ...
    const handleSubmit = (e) => {
        ...
        post(route("form.submit"), {
            forceFormData: true, // Essential for handling files
            preserveScroll: true,
            onSuccess: () => {
                reset()
                                            ...
                                            <span>
                                                <i>
                                                    <svg width={11} height={11} viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1 10L10 1M10 1L1 1M10 1L10 10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                    </svg>
                                                </i>
                                                <i>
                                                    <svg width={11} height={11} viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">

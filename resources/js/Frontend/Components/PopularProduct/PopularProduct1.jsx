...
export default function PopularProduct1({ data }) {
    const { section_title, section_subtitle, action_text, pagination_style, navigation_style, is_auto_play } = data
    const dispatch = useDispatch()
    const popularProducts = localStorage.getItem("popular_products") ? JSON.parse(localStorage.getItem("popular_products")) : []

    // Get shop page URL with popular filter
    const shopUrl = "/shop?filter[type]=popular"

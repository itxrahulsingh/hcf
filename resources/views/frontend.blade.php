...
<head>
    ...
    <link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family={{ $primary_font }}:wght@400;500;600;700;800;900&display=swap" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family={{ $secondary_font }}:wght@400;500;600;700;800;900&display=swap" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family={{ $primary_font }}:wght@400;500;600;700;800;900&display=swap">
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family={{ $secondary_font }}:wght@400;500;600;700;800;900&display=swap">
    </noscript>

    <link rel="preload" href="{{ mix('css/frontend/globals.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="{{ mix('css/frontend/globals.css') }}">
    </noscript>

    <link rel="preload" href="{{ mix('js/frontend/app.js') }}" as="script">
    <script src="{{ mix('js/frontend/app.js') }}" defer></script>

    <link rel="preload" href="{{ route('custom.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
...
<body class="font-sans antialiased {{ $direction }}" style="background-color: #f8f6ea;">
    ...
    <a href="https://wa.me/919625556997"
        ...
        target="_blank"
        aria-label="Chat with Homeless Care Foundation on WhatsApp"
